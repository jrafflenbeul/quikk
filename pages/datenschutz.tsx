		...
		<ThemeWrapper>
			...
			<Container spacing>
				...
				<p>
					...
					Cookies, z.&nbsp;B. f&uuml;r die Warenkorbfunktion) oder zur
					Optimierung der Website (z.&nbsp;B. Cookies zur Messung des
					Webpublikums) erforderlich sind, werden auf Grundlage von Art. 6 Abs.
					1 lit. f DSGVO gespeichert, sofern keine andere Rechtsgrundlage
				...
				<p>
					...
					einer Blacklist gespeichert, um k&uuml;nftige Mailings zu verhindern.
					Die Daten aus der Blacklist werden nur f&uuml;r diesen Zweck verwendet
					und nicht mit anderen Daten zusammengef&uuml;hrt. Dies dient sowohl
				...
				<p>
					...
					<ExternalLink href="https://developers.google.com/fonts/faq" color>
						https://developers.google.com/fonts/faq
					</ExternalLink>{" "}
					und in der Datenschutzerkl&auml;rung von Google:{" "}
					<ExternalLink href="https://policies.google.com/privacy?hl=de" color>
				...
				<p>
					Quelle:{" "}
					<ExternalLink href="https://www.datenschutzerklaerung.de" color>
