...
const impressum = () => {
	return (
		<Container spacing>
			<TitleAndDesc title="Impressum" description="Impressum" />
			<div className="legal">
				<h1>Impressum</h1>
				...
				<p>
					...
					WatchTrade24
					<br />
					Chiemgaustra&szlig;e 78
					<br />
					81549 M&uuml;nchen
				</p>
				<h2>Kontakt</h2>
				<p>
					Telefon: +49 (0) 176 7669 5017
					<br />
					E-Mail: info@watchtrade24.de
				</p>
			...
			<p>
				...
				Deutschland
				<br />
				<ExternalLink href="https://quikk.de" color>
					www.QUIKK.de
				</ExternalLink>
			</p>
		</Container>
