		...
		<ThemeWrapper>
			<Container spacing>
				...
				<p>
					...
					<ExternalLink href="https://ec.europa.eu/consumers/odr/" color>
				...
				<p>
					Quelle:{" "}
					<ExternalLink href="https://www.e-recht24.de" color>
						e-recht24.de
					</ExternalLink>
				</p>
				<h3>Bildnachweis</h3>
				<p>
					...
					<ExternalLink href="https://undraw.co" color>
						undraw.co
					</ExternalLink>{" "}
					und Technologie-Icons, die von{" "}
				...
				<h3>Umsetzung</h3>
				<p>
					Bei der Entwicklung unserer Website und unseres
					Content-Management-Systems sind neben 💖 und ☕ auch Node.js,
					TypeScript, React (Next.js + Vercel), Geist UI und Strapi zum Einsatz
					gekommen.
				</p>
			</Container>
		</ThemeWrapper>
